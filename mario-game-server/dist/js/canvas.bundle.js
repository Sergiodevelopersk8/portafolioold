...
var Plataform = /*#__PURE__*/function () {
  function Plataform(_ref) {
    var x = _ref.x,
        y = _ref.y,
        image = _ref.image;

    _classCallCheck(this, Plataform);
...
function animate() {
  ...
  plataforms.forEach(function (plataform) {
    plataform.draw();
  });
  player.update();
  ...
  if (scrollOffset > platformImage.width * 5 + 300 - 2) {// console.log("ganaste");
  }
